...
adb shell pm enable com.android.setupwizard/org.lineageos.setupwizard.FinishActivity || true
if [[ ! -z "$has_google_suw" ]]
then
    wait ${!}
...
sleep 1
adb shell am start com.android.setupwizard/org.lineageos.setupwizard.FinishActivity || true
if [[ ! -z "$has_google_suw" ]]
then
    wait ${!}
    sleep 1
